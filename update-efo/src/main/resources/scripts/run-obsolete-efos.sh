...
#SBATCH -t 02:00:00
#SBATCH --mem=4G
#SBATCH -o /hps/nobackup/parkinso/spot/gwas/logs/obsolete-efo/slurm-obsolete-efo.out
#SBATCH -e /hps/nobackup/parkinso/spot/gwas/logs/obsolete-efo/slurm-obsolete-efo.err
...
java -DentityExpansionLimit=100000000 \
  ...
  $proxy_settings -Xms4096m -Xmx4096m -jar ${jarLocation}/update-efo.jar