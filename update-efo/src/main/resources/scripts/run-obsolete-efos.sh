...
java -DentityExpansionLimit=100000000  -Dspring.profiles.active=${profile} -Dspring.data.mongodb.username=${DB_USER} Dspring.data.mongodb.password=${DB_PWD}  $proxy_settings -Xms4096m -Xmx4096m -jar $base/update-efo.jar
