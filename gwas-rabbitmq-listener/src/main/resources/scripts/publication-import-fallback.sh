...
java -DentityExpansionLimit=100000000 -Dspring.profiles.active=fallback -Dspring.datasource.username=${ORACLE_DB_USER} -Dspring.datasource.password=${ORACLE_DB_PWD} \
   -Dspring.rabbitmq.username=${RABBIT_USER} -Dspring.rabbitmq.password=${RABBIT_PWD_FALLBACK} \
    ${documentParameters} \
